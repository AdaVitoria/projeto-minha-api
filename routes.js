...
routes.get('/host', HostControler.listAll);
...
routes.put('/host',  HostControler.update);
routes.delete('/host', schemaValidator(hostServerNameSchema), HostControler.delete);

routes.post('/hostUser', schemaValidator(hostServerNameSchema), HostUserController.logarNoHost);
routes.delete('/hostUser', schemaValidator(hostServerNameSchema), HostUserController.logOut);
